		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getConstructorAccess().getMembersAssignment_7(), "rule__Constructor__MembersAssignment_7");
					...
					put(grammarAccess.getInstantiationAccess().getNameAssignment_1(), "rule__Instantiation__NameAssignment_1");
